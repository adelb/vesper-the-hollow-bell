...
export function validateSave(value) {
  ...
  for (const [key, max] of Object.entries({ chapter: 4, unlocked: 4, checkpoint: 1, echoes: 9999999, vitality: 5, blade: 5, deaths: 999999, playtime: 999999999 })) {
  ...
  if (value.bloodstain !== null) {
    ...
    if (!b || !integer(b.chapter, 4) || !integer(b.amount, 9999999) || !Number.isFinite(b.x) || b.x < 0 || b.x > 3820 || !Number.isFinite(b.y) || b.y < 0 || b.y > 540) {
