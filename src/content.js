...
export const BOSS_DRAMA = [
  { title: 'The Lantern Warden', line: 'The light stays here. So do you.', reveal: 'An oath outlived the man who made it.', mutation: 'The Cinder Seraph', mutationLine: 'The cage breaks. What he guarded was inside him.', color: '#f4bf78', body: [80, 132], size: [104, 168], opening: ['execution', 'chainhook', 'charge', 'sweep'], patterns: ['cinderstorm', 'execution', 'chainhook', 'cinder', 'charge', 'sweep'], cue: 'brass', transformed: 'His furnace armour opens into burning wings. Read the three-stroke execution, returning chain-cleaver and alternating cinder eruptions.' },
  { title: 'The Briar Widow', line: 'Hush now. You will wake the children.', reveal: 'She planted a garden so nothing she loved would leave.', mutation: 'Mother of Thorns', mutationLine: 'The cradle was empty. The roots were not.', color: '#cbdca0', body: [108, 115], size: [138, 162], opening: ['thornballet', 'seedcrown', 'leap', 'sweep'], patterns: ['briarweave', 'thornballet', 'seedcrown', 'nova', 'roots', 'leap'], cue: 'roots', transformed: 'Her bridal veil opens into a thorn-crowned blossom. Orbiting seeds and alternating root beds surround a three-limbed embrace.' },
  { title: 'Cantor of the Deep', line: 'One more verse. Then they may rest.', reveal: 'The water took his breath, but not his congregation.', mutation: 'The Thousand-Voiced', mutationLine: 'One mouth falls silent. A hundred open.', color: '#b5e4d5', body: [86, 140], size: [111, 174], opening: ['antiphon', 'procession', 'song', 'sweep'], patterns: ['requiem', 'antiphon', 'procession', 'tidal', 'song', 'nova'], cue: 'choir', transformed: 'The congregation opens a many-voiced halo. Answering chords, three-beat tides and crossing requiem beams require a different rhythm.' },
  { title: 'The Unseeing Astronomer', line: 'Do not look up. It knows your name.', reveal: 'He charted the heavens, and found the city looking back.', mutation: 'The Unbound Constellation', mutationLine: 'The stars were never above him. They were waiting under his skin.', color: '#e5cef6', body: [78, 134], size: [110, 174], opening: ['starcross', 'satellites', 'meteor', 'nova'], patterns: ['eventhorizon', 'starfall', 'starcross', 'eclipse', 'meteor', 'nova'], cue: 'stars', transformed: 'His armillary body releases an orbit of watching eyes. Meridian beams lock their aim before firing; falling constellations leave alternating safe lanes.' },
  { title: 'The Heart of Vesper', line: 'Please. I have only just learned to live.', reveal: 'Every life the city refused to lose. Every goodbye it could not bear.', mutation: 'The City Unmade', mutationLine: 'It remembers every death. Now it remembers yours.', color: '#f3b39e', body: [106, 142], size: [142, 182], opening: ['systole', 'artery', 'charge', 'leap'], patterns: ['coronation', 'lastlight', 'systole', 'artery', 'rapture', 'leap', 'roots'], cue: 'heart', transformed: 'Its sutured heart unfurls a veined mantle. Heartbeat waves, luminous artery beams and splitting memories precede the final coronation.' },
];

export const ENTRANCES = [
  { duration: 8.4, omen: 'THE CHAINS ABOVE YOU TIGHTEN', arrival: 'AN OATH DESCENDS', cue: [0, 7, 12, 19], landmark: 'The Furnace Gate' },
  { duration: 9, omen: 'THE GARDEN HOLDS ITS BREATH', arrival: 'SOMETHING STIRS BENEATH THE VEIL', cue: [19, 15, 12, 7], landmark: 'The Empty Cradle' },
  { duration: 8.8, omen: 'THE WATER BEGINS TO SING', arrival: 'THE CONGREGATION RISES', cue: [0, 10, 15, 22], landmark: 'The Sunken Apse' },
  { duration: 9.2, omen: 'ONE BY ONE, THE STARS GO OUT', arrival: 'THE HEAVENS LOOK BACK', cue: [24, 13, 20, 12], landmark: 'The Inward Observatory' },
  { duration: 9.4, omen: 'THE WHOLE CITY MISSES A HEARTBEAT', arrival: 'A CENTURY OPENS ITS EYES', cue: [0, 1, 7, 12], landmark: 'The Chamber of Borrowed Years' },
];

export const ENEMY_CAST = [
  { husk: { id: 'watchman', name: 'Wickless Watchman', color: '#7c9693', trim: '#dbb783', patterns: ['fencing', 'sweep'], range: 125 }, acolyte: { id: 'censor', name: 'Ash Censor', color: '#76696b', trim: '#e5b47f', patterns: ['censer', 'spread'], range: 370 }, brute: { id: 'gravebearer', name: 'Gravebearer', color: '#70857e', trim: '#cbb99b', patterns: ['tombfall', 'charge', 'sweep'], range: 230 } },
  { husk: { id: 'thornhound', name: 'Thornhound', color: '#607b60', trim: '#c9d69e', patterns: ['maul', 'leap'], range: 185 }, acolyte: { id: 'seedseer', name: 'Seed-Seer', color: '#84916d', trim: '#ddd0a4', patterns: ['seedburst', 'spread'], range: 320 }, brute: { id: 'rootknight', name: 'Rootbound Knight', color: '#68704e', trim: '#c3ca8f', patterns: ['rootmarch', 'sweep'], range: 225 } },
  { husk: { id: 'drowned', name: 'Drowned Duelist', color: '#68989b', trim: '#d4ded0', patterns: ['undertowcut', 'charge'], range: 150 }, acolyte: { id: 'bellmouth', name: 'Bellmouth', color: '#557c8c', trim: '#cadbc6', patterns: ['knell', 'song'], range: 365 }, brute: { id: 'anchorite', name: 'Iron Anchorite', color: '#537680', trim: '#b7c6b4', patterns: ['anchor', 'tidal', 'sweep'], range: 300 } },
  { husk: { id: 'riftstalker', name: 'Rift Stalker', color: '#8986a6', trim: '#e1c3e5', patterns: ['riftcut', 'sweep'], range: 260 }, acolyte: { id: 'orbitseer', name: 'Orbit Seer', color: '#76769e', trim: '#e8d8f2', patterns: ['satellites', 'nova'], range: 370 }, brute: { id: 'glassgolem', name: 'Prismatic Golem', color: '#7e9da8', trim: '#e3e0f4', patterns: ['prism', 'meteor', 'sweep'], range: 360 } },
  { husk: { id: 'paleorphan', name: 'Pale Mourner', color: '#b59b92', trim: '#f0d3b0', patterns: ['lament', 'leap'], range: 170 }, acolyte: { id: 'marrowweaver', name: 'Marrow Weaver', color: '#a07887', trim: '#efc4b9', patterns: ['marrowfan', 'bolt'], range: 360 }, brute: { id: 'pulseknight', name: 'Pulse Knight', color: '#97717c', trim: '#efc3a8', patterns: ['pulsecharge', 'roots', 'sweep'], range: 235 } },
];
...
export const CHAPTERS = [
  {
    ...
    platforms: [[0, 452, 650], [760, 452, 680], [1530, 452, 730], [2360, 452, 800], [3280, 432, 550], [3950, 452, 680], [4770, 416, 440], [5340, 452, 1460], [350, 354, 180], [600, 300, 190], [990, 346, 210], [1260, 285, 190], [1690, 338, 205], [2050, 316, 210], [2270, 368, 190], [2590, 340, 190], [2920, 342, 190], [3150, 275, 170], [3400, 212, 240], [3680, 286, 180], [3910, 338, 175], [4270, 332, 180], [4520, 266, 200], [4790, 208, 225], [5050, 285, 180], [5290, 343, 180], [5600, 336, 180]],
    enemies: [[480, 'husk'], [880, 'husk'], [1120, 'acolyte'], [1630, 'husk'], [1990, 'brute'], [2480, 'acolyte'], [2790, 'husk'], [3010, 'husk'], [3410, 'acolyte'], [3710, 'husk'], [4070, 'brute'], [4460, 'husk'], [4870, 'acolyte'], [5110, 'husk'], [5500, 'brute']],
    hazards: [[1310, 426, 65], [2150, 426, 65], [3550, 406, 75], [4400, 426, 80], [5420, 426, 75]], checkpoint: 1770, lamps: [155, 1770, 4230, 5840], noteX: 1040, arena: 6020, width: 6800,
    districts: [{ x: 2900, name: 'The Lamplighters’ Rooftops', detail: 'Follow the high road above the extinguished windows.', kind: 'clock' }, { x: 4350, name: 'The Foundry of Names', detail: 'Every bell was cast for someone who never came home.', kind: 'furnace' }],
    memories: [{ id: 'ward-roofs', x: 3520, y: 212, title: 'The last lamp on the roof', text: 'Someone kept a ladder beside every chimney. On the highest rung, Mara carved an arrow toward the cathedral. Beneath it, in a smaller hand: “So he can find me.”', reward: 65 }, { id: 'ward-foundry', x: 4900, y: 208, title: 'A name inside the bronze', text: 'The unfinished bell has no clapper. Its maker engraved the name of his wife on the inside, where nobody could see it. He did not want to call her back. He only wanted the sound to remember.', reward: 85 }],
  },
  {
    ...
    platforms: [[0, 452, 510], [630, 452, 560], [1320, 452, 700], [2140, 452, 540], [2780, 452, 430], [3340, 440, 650], [4120, 452, 440], [4690, 432, 520], [5340, 452, 1460], [350, 347, 185], [550, 280, 165], [830, 342, 190], [1100, 285, 180], [1450, 340, 175], [1770, 292, 200], [2020, 347, 185], [2390, 320, 190], [2630, 355, 220], [2970, 341, 180], [3200, 278, 190], [3460, 210, 230], [3740, 281, 180], [3980, 341, 190], [4350, 336, 180], [4590, 267, 190], [4840, 201, 220], [5110, 283, 180], [5360, 345, 180], [5630, 327, 170]],
    enemies: [[400, 'husk'], [790, 'husk'], [1020, 'acolyte'], [1450, 'brute'], [1920, 'husk'], [2310, 'acolyte'], [2860, 'brute'], [3090, 'husk'], [3480, 'husk'], [3830, 'acolyte'], [4280, 'brute'], [4450, 'husk'], [4820, 'acolyte'], [5100, 'husk'], [5530, 'brute']],
    hazards: [[930, 426, 80], [1610, 426, 85], [2470, 426, 70], [3660, 414, 85], [4950, 406, 90], [5450, 426, 70]], checkpoint: 1790, lamps: [155, 1790, 4180, 5840], noteX: 860, arena: 6020, width: 6800,
    districts: [{ x: 2900, name: 'The Glasshouse Canopy', detail: 'Above the thorns, something still reaches for the sun.', kind: 'glasshouse' }, { x: 4350, name: 'The Orchard of Sleep', detail: 'Walk gently. These roots remember footsteps.', kind: 'cradle' }],
    memories: [{ id: 'garden-canopy', x: 3570, y: 210, title: 'A seed in the rafters', text: 'A glass jar hangs where the roots cannot reach. Inside are three dry seeds and a note from Ilex: “Mother, these are the ones you said would bloom after winter. I am still waiting.”', reward: 70 }, { id: 'garden-orchard', x: 4950, y: 201, title: 'The wooden bird', text: 'Mara’s little bird rests in a nest of thorns. One root has curved around it without breaking its wings. For all the garden’s hunger, something here still knows how to be gentle.', reward: 90 }],
  },
  {
    ...
    platforms: [[0, 452, 460], [590, 420, 400], [1130, 452, 870], [2130, 422, 420], [2700, 452, 450], [3290, 410, 400], [3830, 452, 740], [4720, 418, 410], [5270, 452, 1530], [300, 330, 160], [530, 285, 150], [820, 300, 170], [1010, 350, 180], [1350, 334, 185], [1680, 290, 200], [1930, 342, 165], [2350, 315, 175], [2590, 347, 190], [2900, 340, 190], [3140, 270, 180], [3390, 198, 215], [3660, 270, 180], [3910, 340, 185], [4300, 335, 200], [4550, 268, 190], [4800, 204, 210], [5060, 288, 190], [5320, 345, 180], [5590, 334, 180]],
    enemies: [[350, 'acolyte'], [710, 'husk'], [1230, 'brute'], [1510, 'acolyte'], [1890, 'husk'], [2310, 'acolyte'], [2850, 'brute'], [3060, 'husk'], [3440, 'acolyte'], [3990, 'brute'], [4460, 'husk'], [4850, 'acolyte'], [5030, 'husk'], [5390, 'husk'], [5600, 'brute']],
    hazards: [[1440, 426, 70], [2780, 426, 75], [3520, 384, 70], [4370, 426, 80], [5480, 426, 75]], checkpoint: 1740, lamps: [155, 1740, 4160, 5840], noteX: 1280, arena: 6020, width: 6800,
    districts: [{ x: 2900, name: 'The Flooded Belfries', detail: 'Cross above the waterline, where the bells still breathe.', kind: 'belfry' }, { x: 4350, name: 'The Ferrier’s Aqueduct', detail: 'The boats are empty. The crossing remains.', kind: 'ferry' }],
    memories: [{ id: 'choir-belfry', x: 3490, y: 198, title: 'The unstruck bell', text: 'A child tied cloth around this bell before the flood. “So they can sleep,” says the inscription. Even at the end, somebody thought to make the dark a little quieter.', reward: 75 }, { id: 'choir-ferry', x: 4900, y: 204, title: 'Two places in the boat', text: 'Nera’s passenger list ends with two blank lines. Mara filled in neither. Beside them she wrote: “Not yet.” The ink is dry. The ferrier has kept the boat ready.', reward: 95 }],
  },
  {
    ...
    platforms: [[0, 452, 420], [550, 426, 410], [1090, 452, 900], [2130, 426, 400], [2680, 452, 460], [3270, 420, 440], [3850, 442, 720], [4720, 410, 440], [5310, 452, 1490], [290, 340, 175], [510, 278, 170], [760, 312, 165], [980, 355, 165], [1240, 334, 190], [1580, 285, 170], [1900, 339, 200], [2280, 303, 190], [2520, 344, 205], [2890, 338, 180], [3120, 265, 170], [3370, 195, 225], [3650, 266, 180], [3900, 330, 190], [4290, 328, 180], [4530, 261, 190], [4790, 193, 230], [5070, 278, 185], [5330, 341, 180], [5610, 329, 185]],
    enemies: [[340, 'husk'], [690, 'acolyte'], [1210, 'brute'], [1500, 'acolyte'], [1880, 'brute'], [2260, 'acolyte'], [2810, 'brute'], [3020, 'husk'], [3430, 'acolyte'], [3990, 'husk'], [4460, 'brute'], [4830, 'acolyte'], [5060, 'husk'], [5440, 'brute'], [5640, 'acolyte']],
    hazards: [[1390, 426, 75], [1770, 426, 75], [2850, 426, 70], [3530, 394, 75], [4380, 416, 75], [5500, 426, 70]], checkpoint: 1650, lamps: [155, 1650, 4170, 5840], noteX: 1160, arena: 6020, width: 6800,
    districts: [{ x: 2900, name: 'The Meridian Stair', detail: 'Climb between instruments that no longer point outward.', kind: 'orrery' }, { x: 4350, name: 'The Gallery of Unseen Stars', detail: 'The chart continues where the sky should end.', kind: 'telescope' }],
    memories: [{ id: 'spire-meridian', x: 3480, y: 195, title: 'An apprentice’s correction', text: 'Cael crossed out every measurement on the chart except one: the distance between a hand and another hand. “The only measurement that helped,” he wrote in the margin.', reward: 80 }, { id: 'spire-gallery', x: 4900, y: 193, title: 'A sky without witnesses', text: 'The master covered this telescope with a blanket. Underneath, a brass plate reads: “Let there be things that exist without our keeping them.” His final discovery was not a star.', reward: 100 }],
  },
  {
    ...
    platforms: [[0, 452, 530], [650, 432, 460], [1240, 452, 780], [2160, 432, 400], [2700, 452, 470], [3300, 428, 600], [4030, 452, 510], [4680, 420, 510], [5320, 452, 1480], [340, 345, 180], [570, 295, 165], [900, 328, 180], [1140, 350, 170], [1450, 328, 185], [1810, 300, 175], [2050, 350, 180], [2380, 322, 180], [2590, 348, 180], [2940, 339, 180], [3180, 272, 180], [3430, 207, 230], [3710, 280, 180], [3960, 343, 190], [4310, 335, 180], [4550, 268, 190], [4800, 200, 230], [5080, 282, 180], [5340, 346, 190], [5620, 332, 180]],
    enemies: [[390, 'husk'], [760, 'acolyte'], [1350, 'brute'], [1610, 'acolyte'], [1930, 'brute'], [2260, 'acolyte'], [2830, 'brute'], [3060, 'husk'], [3430, 'acolyte'], [3790, 'husk'], [4390, 'brute'], [4800, 'acolyte'], [5080, 'husk'], [5420, 'brute'], [5630, 'husk']],
    hazards: [[1510, 426, 75], [2750, 426, 80], [3600, 402, 85], [4940, 394, 80], [5520, 426, 85]], checkpoint: 1730, lamps: [155, 1730, 4170, 5840], noteX: 1300, arena: 6020, width: 6800,
    districts: [{ x: 2900, name: 'The Artery Causeway', detail: 'Every bridge answers the pulse beneath your feet.', kind: 'artery' }, { x: 4350, name: 'The Houses Within', detail: 'A city remembers the rooms where it was loved.', kind: 'memory' }],
    memories: [{ id: 'heart-artery', x: 3540, y: 207, title: 'A rhythm for two', text: 'At first you hear only the enormous pulse. Then, between its beats, another: the rhythm Mara tapped on your window when she wanted to go outside. She is still finding ways to call you.', reward: 85 }, { id: 'heart-houses', x: 4910, y: 200, title: 'The room it remembered', text: 'Inside the wall is a room exactly like yours, except there are two lanterns in the window. The heart did not understand forever. It only understood that someone was always supposed to come home.', reward: 110 }],
  },
];
